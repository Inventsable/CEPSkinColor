...
function reColorUI(){
  ...
  btnCorner[0].style.borderColor = appInfo.color;
  btnCorner[0].style.borderLeftColor = 'transparent';
  btnCorner[0].style.borderRightColor = 'transparent';

  btnUpDown[0].style.color = appInfo.color;
  btnUpDown[0].style.borderColor = appInfo.borderColor;
  btnUpDown[0].style.backgroundColor = appInfo.inputBGColorIdle;

  // btnCorner.forEach(function(v,i,a) {
  //   v.style.borderColor = appInfo.color;
  //   v.style.borderLeftColor = 'transparent';
  //   v.style.borderRightColor = 'transparent';
  // });
  //
